...
class PostTest {
    ...
    fun testListReposContains5a5() {
        ...
        fun testInscriptionPuisAccueil() {
            ...
            assertTrue(
                "Inscription échouée: ${reponseInscription.code()}",
                reponseInscription.isSuccessful
            )

            val corpsInscription = reponseInscription.body() ?: ""
            assertTrue(
                "La réponse d'inscription ne contient pas le nom d'utilisateur",
        ...
        fun testConnexionPuisAccueil() {
            ...
            assertTrue(
                "Connexion échouée: ${reponseConnexion.code()}",
                reponseConnexion.isSuccessful
            )
            ...
            assertTrue(
                "Accueil échoué après connexion: ${reponseAccueil.code()}",
                reponseAccueil.isSuccessful
            )
